...
class PerkTypeException(DomainException):
    def __init__(self, invalid_attr_obj: object, message: str):
        ...
        self.message = message or (
            f"Неверный тип атрибута, ожидается объект Perk, передан: {invalid_attr_obj}"
        )
        super().__init__(message=self.message, error_code="PERK-ATTR-TYPE-ERROR")
...
class StatEnumTypeException(DomainException):
    def __init__(self, invalid_attr_obj: object, message: str):
        self.invalid_attr_obj = invalid_attr_obj
        self.message = message or (
            f"Неверный тип атрибута, "
            f"ожидается объект StatEnum, "
            f"передан: {invalid_attr_obj}"
        )
        super().__init__(message=self.message, error_code="STAT-ATTR-TYPE-ERROR")
...
class MultiplierAmountTypeException(DomainException):
    def __init__(self, invalid_attr_obj: object, message: str):
        self.invalid_attr_obj = invalid_attr_obj
        self.message = message or (
            f"Неверный тип атрибута, ожидается объект int, передан: {invalid_attr_obj}"
        )
        super().__init__(
            message=self.message, error_code="MULTIPLIER-AMOUNT-ATTR-TYPE-ERROR"
        )
...
class MeasurementTypeException(DomainException):
    def __init__(self, invalid_attr_obj: object, message: str):
        ...
        super().__init__(message=self.message, error_code="MEASUREMENT-ATTR-TYPE-ERROR")


class NamePerkException(DomainException):
    def __init__(self, name_perk: object | str, message: str):
        self.message = message or (
            "Неверный тип атрибута, "
        ...
        super().__init__(message=self.message, error_code="NAME-PERK-ATTR-ERROR")
