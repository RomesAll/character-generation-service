...
class GroupPerk:
    ...
    def __init__(self, group_stats: weakref.ref["GroupStat"] | None = None) -> None:
        """
        Инициализация объекта, принимает (опционально) слабую ссылку на группу статов GroupStat
        :param group_stats: слабая ссылка GroupStat
        """
        super().__init__()
    ...
    def group_stats(self):
        """
        Получить группу статов GroupStat
        :return:
        """
    ...
    def group_stats(self, value: weakref.ref["GroupStat"]):
        """
        Обновить группу статов новым объектом GroupStat
        :param value:
        :return:
        """
    ...
    def add(self, *, name_perk: str, multipliers: list[PerkMultiplier]) -> Self:
        """
        Добавление перка
        :param name_perk: название перка
        :param multipliers: модификаторы
        :return:
        """
    ...
    def refresh_all_multiplier(self):
        """
        Обновить модификаторы перков в статах
        :return:
        """
