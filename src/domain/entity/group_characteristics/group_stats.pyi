...
class GroupStat:
    ...
    def health(self, current: int, maximum: int) -> Health: ...
    def action_point(self, current: int, maximum: int) -> ActionPoint: ...
    def bravery(self, current: int, maximum: int) -> Bravery: ...
    def endurance(self, current: int, maximum: int) -> Endurance: ...
    def initiative(self, current: int, maximum: int) -> Initiative: ...
    def melee_defense(self, current: int, maximum: int) -> MeleeDefense: ...
    def shooting_protection(self, current: int, maximum: int) -> ShootingProtection: ...
    def damage(self, current: int, maximum: int) -> Damage: ...
    def visibility(self, current: int, maximum: int) -> Visibility: ...
    def moral(self, current: int, maximum: int) -> Moral: ...
    def hand_skill(self, current: int, maximum: int) -> HandSkill: ...
    def shooting_skill(self, current: int, maximum: int) -> ShootingSkill: ...
    def damage_armor(self, current: int, maximum: int) -> DamageArmor: ...
    def head_hit_chance(self, current: int, maximum: int) -> HeadHitChance: ...
