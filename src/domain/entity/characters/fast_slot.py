...
class ArmsFastSlot(BaseModel):
    ...
    def __init__(
        ...
        self.left_hand = self.ManageHandItem(
            hand_name=BodyPart.LEFT_HAND, item_in_hand=left_hand
        )
        self.right_hand = self.ManageHandItem(
            hand_name=BodyPart.RIGHT_HAND, item_in_hand=right_hand
        )
...
class ArmorFastSlot(BaseModel):
    ...
    def __init__(
        ...
        self.head = self.ManageArmorItem(
            body_part_name=BodyPart.HEAD, armor=head
        )
        self.body = self.ManageArmorItem(
            body_part_name=BodyPart.BODY, armor=body
        )
